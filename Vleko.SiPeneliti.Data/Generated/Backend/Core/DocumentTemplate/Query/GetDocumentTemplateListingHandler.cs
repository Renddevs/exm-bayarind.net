...
namespace Vleko.SiPeneliti.Core.DocumentTemplate.Query
{
    ...
    internal class GetDocumentTemplateListHandler : IRequestHandler<GetDocumentTemplateListRequest, ListResponse<DocumentTemplateResponse>>
    {
        ...
        public async Task<ListResponse<DocumentTemplateResponse>> Handle(GetDocumentTemplateListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<Vleko.SiPeneliti.Data.Model.DocumentTemplate>().AsQueryable();

				#region Filter
				Expression<Func<Vleko.SiPeneliti.Data.Model.DocumentTemplate, object>> column_sort = null;
				List<Expression<Func<Vleko.SiPeneliti.Data.Model.DocumentTemplate, bool>>> where = new List<Expression<Func<Vleko.SiPeneliti.Data.Model.DocumentTemplate, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<Vleko.SiPeneliti.Data.Model.DocumentTemplate, bool>> where, Expression<Func<Vleko.SiPeneliti.Data.Model.DocumentTemplate, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Vleko.SiPeneliti.Data.Model.DocumentTemplate, object>> result_order = null;
			Expression<Func<Vleko.SiPeneliti.Data.Model.DocumentTemplate, bool>> result_where = null;
