...
namespace Vleko.SiPeneliti.Core.User.Command
{
    ...
    public class EditUserRequest :UserRequest, IMapRequest<Vleko.SiPeneliti.Data.Model.User, EditUserRequest>,IRequest<StatusResponse>
    {
        [Required]
        public Guid Id { get; set; }
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<EditUserRequest, Vleko.SiPeneliti.Data.Model.User> map)
        {
    ...
    internal class EditUserHandler : IRequestHandler<EditUserRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(EditUserRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var existingItems = await _context.Entity<Vleko.SiPeneliti.Data.Model.User>().Where(d => d.Id == request.Id).FirstOrDefaultAsync();
