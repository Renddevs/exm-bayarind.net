...
namespace Vleko.SiPeneliti.Core.WorkflowStatus.Command
{
    ...
    public class EditWorkflowStatusRequest :WorkflowStatusRequest, IMapRequest<Vleko.SiPeneliti.Data.Model.WorkflowStatus, EditWorkflowStatusRequest>,IRequest<StatusResponse>
    {
        [Required]
        public short Id { get; set; }
        [Required]
        public string Inputer { get; set; }
        public void Mapping(IMappingExpression<EditWorkflowStatusRequest, Vleko.SiPeneliti.Data.Model.WorkflowStatus> map)
        {
    ...
    internal class EditWorkflowStatusHandler : IRequestHandler<EditWorkflowStatusRequest, StatusResponse>
    {
        ...
        public async Task<StatusResponse> Handle(EditWorkflowStatusRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var existingItems = await _context.Entity<Vleko.SiPeneliti.Data.Model.WorkflowStatus>().Where(d => d.Id == request.Id).FirstOrDefaultAsync();
