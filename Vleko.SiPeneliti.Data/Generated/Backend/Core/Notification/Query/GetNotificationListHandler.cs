...
namespace Vleko.SiPeneliti.Core.Notification.Query
{
    ...
    internal class GetNotificationListHandler : IRequestHandler<GetNotificationListRequest, ListResponse<NotificationResponse>>
    {
        ...
        public async Task<ListResponse<NotificationResponse>> Handle(GetNotificationListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<Vleko.SiPeneliti.Data.Model.Notification>().AsQueryable();

				#region Filter
				Expression<Func<Vleko.SiPeneliti.Data.Model.Notification, object>> column_sort = null;
				List<Expression<Func<Vleko.SiPeneliti.Data.Model.Notification, bool>>> where = new List<Expression<Func<Vleko.SiPeneliti.Data.Model.Notification, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<Vleko.SiPeneliti.Data.Model.Notification, bool>> where, Expression<Func<Vleko.SiPeneliti.Data.Model.Notification, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Vleko.SiPeneliti.Data.Model.Notification, object>> result_order = null;
			Expression<Func<Vleko.SiPeneliti.Data.Model.Notification, bool>> result_where = null;
