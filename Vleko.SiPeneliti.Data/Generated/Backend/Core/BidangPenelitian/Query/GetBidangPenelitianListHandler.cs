...
{
    public class GetBidangPenelitianListRequest : ListRequest,IListRequest<GetBidangPenelitianListRequest>,IRequest<ListResponse<BidangPenelitianResponse>>
    {
    }
    internal class GetBidangPenelitianListHandler : IRequestHandler<GetBidangPenelitianListRequest, ListResponse<BidangPenelitianResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetBidangPenelitianListHandler(
            ILogger<GetBidangPenelitianListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<BidangPenelitianResponse>> Handle(GetBidangPenelitianListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<BidangPenelitianResponse> result = new ListResponse<BidangPenelitianResponse>();
            try
            {
				var query = _context.Entity<Vleko.SiPeneliti.Data.Model.BidangPenelitian>().AsQueryable();

				#region Filter
				Expression<Func<Vleko.SiPeneliti.Data.Model.BidangPenelitian, object>> column_sort = null;
				List<Expression<Func<Vleko.SiPeneliti.Data.Model.BidangPenelitian, bool>>> where = new List<Expression<Func<Vleko.SiPeneliti.Data.Model.BidangPenelitian, bool>>>();
				...
				result.List = _mapper.Map<List<BidangPenelitianResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List BidangPenelitian", request);
                result.Error("Failed Get List BidangPenelitian", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Vleko.SiPeneliti.Data.Model.BidangPenelitian, bool>> where, Expression<Func<Vleko.SiPeneliti.Data.Model.BidangPenelitian, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Vleko.SiPeneliti.Data.Model.BidangPenelitian, object>> result_order = null;
			Expression<Func<Vleko.SiPeneliti.Data.Model.BidangPenelitian, bool>> result_where = null;
