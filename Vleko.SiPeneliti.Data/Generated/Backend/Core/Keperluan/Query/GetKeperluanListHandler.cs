...
{
    public class GetKeperluanListRequest : ListRequest,IListRequest<GetKeperluanListRequest>,IRequest<ListResponse<KeperluanResponse>>
    {
    }
    internal class GetKeperluanListHandler : IRequestHandler<GetKeperluanListRequest, ListResponse<KeperluanResponse>>
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork<ApplicationDBContext> _context;
        public GetKeperluanListHandler(
            ILogger<GetKeperluanListHandler> logger,
            IMapper mapper,
        ...
        public async Task<ListResponse<KeperluanResponse>> Handle(GetKeperluanListRequest request, CancellationToken cancellationToken)
        {
            ListResponse<KeperluanResponse> result = new ListResponse<KeperluanResponse>();
            try
            {
				var query = _context.Entity<Vleko.SiPeneliti.Data.Model.Keperluan>().AsQueryable();

				#region Filter
				Expression<Func<Vleko.SiPeneliti.Data.Model.Keperluan, object>> column_sort = null;
				List<Expression<Func<Vleko.SiPeneliti.Data.Model.Keperluan, bool>>> where = new List<Expression<Func<Vleko.SiPeneliti.Data.Model.Keperluan, bool>>>();
				...
				result.List = _mapper.Map<List<KeperluanResponse>>(data_list);
            ...
            {
                _logger.LogError(ex, "Failed Get List Keperluan", request);
                result.Error("Failed Get List Keperluan", ex.Message);
            }
            return result;
        }

        #region List Utility
		private (Expression<Func<Vleko.SiPeneliti.Data.Model.Keperluan, bool>> where, Expression<Func<Vleko.SiPeneliti.Data.Model.Keperluan, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Vleko.SiPeneliti.Data.Model.Keperluan, object>> result_order = null;
			Expression<Func<Vleko.SiPeneliti.Data.Model.Keperluan, bool>> result_where = null;
