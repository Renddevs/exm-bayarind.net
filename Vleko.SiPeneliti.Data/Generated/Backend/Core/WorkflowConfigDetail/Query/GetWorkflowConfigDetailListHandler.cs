...
namespace Vleko.SiPeneliti.Core.WorkflowConfigDetail.Query
{
    ...
    internal class GetWorkflowConfigDetailListHandler : IRequestHandler<GetWorkflowConfigDetailListRequest, ListResponse<WorkflowConfigDetailResponse>>
    {
        ...
        public async Task<ListResponse<WorkflowConfigDetailResponse>> Handle(GetWorkflowConfigDetailListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<Vleko.SiPeneliti.Data.Model.WorkflowConfigDetail>().AsQueryable();

				#region Filter
				Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfigDetail, object>> column_sort = null;
				List<Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfigDetail, bool>>> where = new List<Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfigDetail, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfigDetail, bool>> where, Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfigDetail, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfigDetail, object>> result_order = null;
			Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfigDetail, bool>> result_where = null;
