...
namespace Vleko.SiPeneliti.Core.WorkflowConfig.Query
{
    ...
    internal class GetWorkflowConfigListHandler : IRequestHandler<GetWorkflowConfigListRequest, ListResponse<WorkflowConfigResponse>>
    {
        ...
        public async Task<ListResponse<WorkflowConfigResponse>> Handle(GetWorkflowConfigListRequest request, CancellationToken cancellationToken)
        {
            ...
            try
            {
				var query = _context.Entity<Vleko.SiPeneliti.Data.Model.WorkflowConfig>().AsQueryable();

				#region Filter
				Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfig, object>> column_sort = null;
				List<Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfig, bool>>> where = new List<Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfig, bool>>>();
        ...
        #region List Utility
		private (Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfig, bool>> where, Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfig, object>> order) ListExpression(string search, string field, bool is_where)
		{
			Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfig, object>> result_order = null;
			Expression<Func<Vleko.SiPeneliti.Data.Model.WorkflowConfig, bool>> result_where = null;
